...
const VIEW_STORAGE_KEY = 'currentView';
    ...
    const executeAndHandleResult = async (commandName, resultHandler) => {
        try {
            const result = await window.ipcRenderer.invoke('executeCommand', commandName);
...
documentsBtn.addEventListener('click', () => {
    ...
    executeAndHandleResult('getWindowsDocumentsFiles', 'listOfDocumentsFiles');
});
